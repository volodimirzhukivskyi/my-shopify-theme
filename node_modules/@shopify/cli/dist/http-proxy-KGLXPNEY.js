...
var require_common = __commonJS({
  "../../node_modules/.pnpm/http-proxy@1.18.1/node_modules/http-proxy/lib/http-proxy/common.js"(exports) {
    init_cjs_shims();
    var common = exports, url = __require("url"), extend = __require("util")._extend, required = require_requires_port(), upgradeHeader = /(^|,)\s*upgrade\s*($|,)/i, isSSL = /^https|wss/;
    common.isSSL = isSSL;
    ...
    common.urlJoin = function() {
      ...
      ], retSegs.push.apply(retSegs, lastSegs), retSegs.join("?");
    };
...
var require_web_outgoing = __commonJS({
  "../../node_modules/.pnpm/http-proxy@1.18.1/node_modules/http-proxy/lib/http-proxy/passes/web-outgoing.js"(exports, module) {
    init_cjs_shims();
...
var require_web_incoming = __commonJS({
  "../../node_modules/.pnpm/http-proxy@1.18.1/node_modules/http-proxy/lib/http-proxy/passes/web-incoming.js"(exports, module) {
    init_cjs_shims();
...
var require_ws_incoming = __commonJS({
  "../../node_modules/.pnpm/http-proxy@1.18.1/node_modules/http-proxy/lib/http-proxy/passes/ws-incoming.js"(exports, module) {
    init_cjs_shims();
...
var require_http_proxy = __commonJS({
  "../../node_modules/.pnpm/http-proxy@1.18.1/node_modules/http-proxy/lib/http-proxy/index.js"(exports, module) {
    init_cjs_shims();
    var httpProxy = module.exports, extend = __require("util")._extend, parse_url = __require("url").parse, EE3 = require_eventemitter3(), http = __require("http"), https = __require("https"), web = require_web_incoming(), ws = require_ws_incoming();
...
var require_http_proxy2 = __commonJS({
  "../../node_modules/.pnpm/http-proxy@1.18.1/node_modules/http-proxy/lib/http-proxy.js"(exports, module) {
    init_cjs_shims();
...
var require_http_proxy3 = __commonJS({
  "../../node_modules/.pnpm/http-proxy@1.18.1/node_modules/http-proxy/index.js"(exports, module) {
    init_cjs_shims();
    module.exports = require_http_proxy2();
  }
});
export default require_http_proxy3();
